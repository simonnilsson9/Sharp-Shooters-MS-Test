...
[assembly: InternalsVisibleTo("SharpShooters.MSTest")]
namespace Sharp_Shooters
{
    internal class TransferData //The properties we need to make a transfer
    {
        ...
        public static void TransferCallback(object state)
        {
        ...
        public static void NewTransfer(User loggedInUser, List<User> users)
        {
